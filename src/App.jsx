...
const STR = {
  fr: {
    ...
    resumed: "repris",
    willResume: "En attente · reprise possible",
    queued: "En attente",
    ...
    storeIntro: "Choisissez un espace, puis écrivez-nous : nous vous indiquons comment payer et le compte est étendu sous 48 h. Un seul paiement, définitif.",
    askPlan: "Demander ce forfait",
    storeNote: "Paiement unique par Mobile Money : l'espace est acquis, sans abonnement ni prélèvement automatique. Vos fichiers restent consultables même si le quota est atteint — seul l'envoi est bloqué.",
  ...
  mg: {
    ...
    resumed: "notohizana",
    willResume: "Miandry · azo tohizana",
    queued: "Miandry",
    ...
    storeNote: "Fandoavana indray mandeha amin'ny Mobile Money: azonao mandrakizay ny toerana, tsy misy famerenana na fisintomana automatique. Mbola azo jerena ny rakitrao na feno aza ny toerana — ny fandefasana ihany no voasakana.",
  ...
  en: {
    ...
    storeNote: "One-time payment by Mobile Money: the space is yours, no subscription and no automatic charge. Your files stay readable once the quota is full — only uploads are blocked.",
...
function StoreView({ onBack, user, t }) {
  ...
  const mailto = plan => {
    ...
    const body = [
      `Bonjour,`,
      ``,
      `Je souhaite passer au forfait ${plan.to} To (${ariary(plan.ar)} Ar, paiement unique).`,
      ``,
      `Compte : ${user?.email || ""}`,
      ``,
